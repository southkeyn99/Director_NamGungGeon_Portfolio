    ...
    <footer className="bg-cinematic-dark text-neutral-500 py-12 border-t border-neutral-800">
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex space-x-6">
          ...
          <a href={`https://${DIRECTOR_INFO.vimeo}`} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-300">
            <Video size={20} /> {/* Represents Vimeo */}
          </a>
